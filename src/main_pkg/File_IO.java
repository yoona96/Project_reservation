...
public class File_IO {
        ...
        try {
            ...
            while ((line = buffered_reader.readLine()) != null) {
                ...
                if (time > 10) {
                    ...
                    /* time   10蹂대      ㅻ㈃,line_split   temp   梨   以     . */
    ...
    /* time   0~10源 吏    媛  대ŉ table   0~19源 吏    媛        */
    public void write_file(String date, int time, int table) {
        /* "date.txt" 쇰   紐 移       쇱   "src/data/"寃쎈      濡    ⑸    . */
        try {
            File file = new File("src/data/" + date + ".txt");
            FileReader file_reader = new FileReader(file);
            BufferedReader buffered_reader = new BufferedReader(file_reader);
            ...
            change_line += "\r\n";
            /* position 以   댁  源 吏     댁 ⑹        String      ν ⑸    . */
            for (int i = 0; i < position; i++) {
                buffered_reader.readLine();
                temp += (line + "\r\n");
            }
            /*      String   position 以     쎌 댁   吏   移⑸    . */
            buffered_reader.readLine();
            temp += change_line;
            /* 洹   댄   以     쎄       String      ν ⑸    . */
            while ((line = buffered_reader.readLine()) != null) {
